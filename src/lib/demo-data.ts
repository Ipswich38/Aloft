...
export const demoOrders: Order[] = [
  { id: "ord-1001", customerId: "demo-customer", merchantId: "demo-merchant", originSiteId: "site-1", destSiteId: "site-2", category: "medicine", cargoDescription: "Vaccines (cold chain) ×2 boxes", weightKg: 4.5, priority: true, deliveryMode: "air", status: "in_flight", flightId: "flt-1", priceCentavos: 185000, createdAt: "2026-06-06T01:10:00Z" },
  { id: "ord-1002", customerId: "demo-customer", merchantId: "demo-merchant", originSiteId: "site-1", destSiteId: "site-3", category: "medicine", cargoDescription: "Lab samples — STAT", weightKg: 1.2, priority: true, deliveryMode: "air", status: "accepted", flightId: null, priceCentavos: 145000, createdAt: "2026-06-06T02:05:00Z" },
  { id: "ord-1003", customerId: "demo-customer", merchantId: null, originSiteId: "site-1", destSiteId: "site-4", category: "groceries", cargoDescription: "Rice, canned goods, eggs", weightKg: 8.0, priority: false, deliveryMode: "land", status: "submitted", flightId: null, priceCentavos: 104000, createdAt: "2026-06-06T03:20:00Z" },
  { id: "ord-1000", customerId: "demo-customer", merchantId: "demo-merchant", originSiteId: "site-1", destSiteId: "site-2", category: "food", cargoDescription: "Lechon + sides (hot bag)", weightKg: 2.0, priority: true, deliveryMode: "air", status: "delivered", flightId: null, priceCentavos: 156000, createdAt: "2026-06-03T22:40:00Z" },
  { id: "ord-0999", customerId: "demo-customer", merchantId: "demo-merchant", originSiteId: "site-1", destSiteId: "site-3", category: "parcel", cargoDescription: "Signed documents (envelope)", weightKg: 0.3, priority: false, deliveryMode: "land", status: "delivered", flightId: null, priceCentavos: 67800, createdAt: "2026-06-01T09:15:00Z" },
];
