...
insert into drones (id, model, tail_number, caap_registration, registration_expiry, status) values
  ('aaaa1111-0000-0000-0000-000000000001','FC30','ALOFT-01','RPAS-2026-0451','2027-03-31','active'),
  ('aaaa1111-0000-0000-0000-000000000002','FC30','ALOFT-02','RPAS-2026-0452','2027-03-31','active'),
  ('aaaa1111-0000-0000-0000-000000000003','FC100','ALOFT-03',null,null,'maintenance')
on conflict (id) do nothing;
